...
export interface RawQuadrimestreData {
    "1": string | number;
    "2": string | number;
    "3": string | number;
}

export interface RawGoalDataItem {
    id: number;
    title: string;
    esperado: string | number;
    resultado: string | number;
...
export interface RawObjetivoData {
    [objetivoTitle: string]: RawGoalDataItem[];
}

export interface RawDiretrizData {
...
export const dataSets: RawDataSets = {
      "2022": {
